...
| 10             | strcat_s             | 拼接字符串                                                                                                                  |                                                                                                                                                                                             |
| 11             | 格式化函数           | sscanf_s                                                                                                                    | 从字符串格式化读取数据                                                                                                                                                                      |
| 12             | sprintf_s            | 数据格式化输出到字符串                                                                                                      |                                                                                                                                                                                             |
| 13             | 字符串和整型转换函数 | strtol                                                                                                                      | 字符串转换成long型。根据最新规范，**避免**使用atoi、atol函数。                                                                                                                        |
| 14             | strtoll              | 字符串转换成long long型。根据最新规范，**避免**使用atoll函数。                                                        |                                                                                                                                                                                             |
| 15             | 常用位运算符         | 按位与(&)                                                                                                                   | 两个数据的同一位置均为1时则该位为1，其他情况则该位为0                                                                                                                                       |
| 16             | 按位或(              | )                                                                                                                           | 两个数据的同一位置有1时则该位为1，其他情况则该位为0                                                                                                                                         |
| 17             | 按位异或(^)          | 两个数据的同一位置相同时则该位为0，其他情况则该位为1                                                                        |                                                                                                                                                                                             |
| 18             | 按位取反(~)          | 二进制每位上的1变为0，0变为1                                                                                                |                                                                                                                                                                                             |
| 19             | 左移运算符（<<）     | 左移若干位，左边的二进制位丢弃，右边补0；若移位后高位不包含1，则每左移一位，相当于该数乘以2。                               |                                                                                                                                                                                             |
| 20             | 右移运算符（>>）     | 右移若干位，正数左补0，负数左补1，右边丢弃。``每右移一位，相当于该数除以2。                                          |                                                                                                                                                                                             |
| 21             | 数据结构             | VosVector                                                                                                                   | 数组                                                                                                                                                                                        |
| 22             | VosList              | 列表                                                                                                                        |                                                                                                                                                                                             |
| 23             | VosMap               | Map                                                                                                                         |                                                                                                                                                                                             |
| 24             | VosPriQue            | 优先队列                                                                                                                    |                                                                                                                                                                                             |
| 25             | VosHash              | hash                                                                                                                        |                                                                                                                                                                                             |
